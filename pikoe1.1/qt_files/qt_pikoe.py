...
class MyWindow(QMainWindow, uic.loadUiType("qt_pikoe_main.ui")[0]):
    def __init__(self):
        ...
        self.actionMake_potential_table.triggered.connect(self.open_omp) 
        #---add Widgets
